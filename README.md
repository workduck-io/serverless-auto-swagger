...
custom:
    autoswagger:
        ...
        includeStages: undefined
```

| Option                    | Description                                                                                                                                                   | Default                                                                    | Example                                                  |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------- |
| `generateSwaggerOnDeploy` | Boolean which indicates whether to generate a new swagger file on deployment                                                                                  | `true`                                                                     |                                                          |
| `deploySwagger`           | Boolean which indicates whether to deploy the swagger file on deployment                                                                                      | `true`                                                                     |                                                          |
...
| `includeStages`           | Array of strings that contains stages in which Swagger UI and Swagger JSON lambdas **should** be deployed in. Leave undefined to include all                  | `undefined`                                                                |                                                          |
| `excludeStages`           | Array of strings that contains stages in which Swagger UI and Swagger JSON lambdas should **not** be deployed in. This holds more priority than includeStages | `[]`                                                                       |                                                          |
